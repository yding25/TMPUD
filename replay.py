...
def main():
    ...
    try:
        ...
        time.sleep(5)
        # replay the session
        recording_name = 'recording_1642933177.log'
        carla_version = 'CARLA_0.9.10.1'
        address1 = '/home/' + getpass.getuser() + '/' + carla_version + '/PythonAPI/TMPUD/saved/'
        args.recorder_filename = address1 + recording_name
